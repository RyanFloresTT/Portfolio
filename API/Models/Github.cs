...
public class GitHubRepository {
    ...
    [JsonPropertyName("license")] public object? License { get; set; } // Can be null or a license object
...
public class GitHubCommit {
    ...
    [JsonPropertyName("commit")] public CommitDetail? Commit { get; set; }
    ...
    [JsonPropertyName("parents")] public CommitParent[]? Parents { get; set; }
}

public class CommitDetail {
    [JsonPropertyName("author")] public CommitAuthor? Author { get; set; }

    [JsonPropertyName("committer")] public CommitAuthor? Committer { get; set; }

    [JsonPropertyName("message")] public string? Message { get; set; }

    [JsonPropertyName("tree")] public CommitTree? Tree { get; set; }

    [JsonPropertyName("url")] public string? Url { get; set; }

    [JsonPropertyName("comment_count")] public int CommentCount { get; set; }

    [JsonPropertyName("verification")] public CommitVerification? Verification { get; set; }
}
