      ...
      <div class="max-w-6xl mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
              ...
              <div class="space-y-4 text-gray-700">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="bg-blue-50 p-3 rounded-lg">
                    <h4 class="font-semibold text-blue-800 mb-1">Frontend</h4>
                    <p class="text-sm text-blue-700">Angular 17, Tailwind CSS, TypeScript</p>
                  </div>
                  <div class="bg-green-50 p-3 rounded-lg">
                    <h4 class="font-semibold text-green-800 mb-1">Backend</h4>
                    <p class="text-sm text-green-700">.NET 8, SignalR, Entity Framework</p>
                  </div>
                  <div class="bg-purple-50 p-3 rounded-lg">
                    <h4 class="font-semibold text-purple-800 mb-1">Infrastructure</h4>
                    <p class="text-sm text-purple-700">Docker, Kubernetes, Redis</p>
                  </div>
                  <div class="bg-orange-50 p-3 rounded-lg">
                    <h4 class="font-semibold text-orange-800 mb-1">AI Integration</h4>
                    <p class="text-sm text-orange-700">Ollama, Llama 3.2</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="space-y-3">
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium">{{ portfolioService.connectionStatus() }}</span>
                  </div>
                </div>
                
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span class="text-gray-700">Data Sources</span>
                  <span class="text-sm font-medium text-green-600">GitHub API</span>
                </div>
                
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span class="text-gray-700">Real-time Updates</span>
                  <span class="text-sm font-medium text-green-600">SignalR Active</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-8 pt-6 border-t border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="text-center">
                ...
                <p class="text-sm text-gray-600">GitHub commits sync automatically every hour, with live updates via SignalR</p>
              </div>
              ...
              <div class="text-center">
                ...
                <h4 class="font-semibold text-gray-800 mb-2">AI-Powered</h4>
                <p class="text-sm text-gray-600">Personal summaries generated using Ollama and Llama 3.2 based on recent commits</p>
              </div>
              ...
              <div class="text-center">
                ...
                <p class="text-sm text-gray-600">Full Docker setup with Kubernetes deployment for scalability and reliability</p>
              </div>
            </div>
          </div>
          ...
          <div class="mt-8 pt-6 border-t border-gray-200">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 class="font-semibold text-gray-800 mb-2">Backend Services</h4>
                ...
                <div>
                  <h4 class="font-semibold text-gray-800 mb-2">Frontend Features</h4>
                  <ul class="text-sm text-gray-600 space-y-1">
          ...
          <div class="mt-8 pt-6 border-t border-gray-200 text-center">
            <p class="text-gray-600 mb-4">Want to learn more about the technical implementation?</p>
